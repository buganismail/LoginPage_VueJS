<template>
    ...
    <div class="tardis">
      ...
      <div class="side">
        <div class="top-sign">
          <div class="text">
            <span class="left">Hoş</span>
            <span class="tiny"></span>
            <span class="right">Geldiniz</span>
          </div>
        </div>
        <div class="door-frame">
          <div class="door door-left">
      ...
      <div class="side">
        <div class="top-sign">
          <div class="text">
            <span class="left">Teknoloji</span>
            <span class="tiny"></span>
            <span class="right">Yazılım</span>
          </div>
        </div>
        <div class="door-frame">
          <div class="door door-left">
      ...
      <div class="side">
        <div class="top-sign">
          <div class="text">
            <span class="left">Gençlik</span>
            <span class="tiny"></span>
            <span class="right">Hamlesi</span>
          </div>
        </div>
        <div class="door-frame">
          <div class="door door-left">
